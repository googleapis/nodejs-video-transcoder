...
describe('v1.TranscoderServiceClient', () => {
    ...
    describe('createJob', () => {
        it('invokes createJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.video.transcoder.v1.Job());
    ...
    describe('createJobTemplate', () => {
        it('invokes createJobTemplate without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.video.transcoder.v1.JobTemplate());
